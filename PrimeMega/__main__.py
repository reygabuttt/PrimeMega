...
PM_START_TEXT = """
 ───「[Todoroki](http://t.me/TodorokiTpiBot)」───
*Hello {} !*
────────────────────────
ᴛᴏᴅᴏʀᴏᴋɪ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ʙᴜɪʟᴛ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ!
────────────────────
...
buttons = [
        ...
        InlineKeyboardButton(
            text="➕️ Add Todoroki to your group ➕️", url="t.me/TodorokiTpiBot?startgroup=true"
        ),
    ],
    [
...
PRIME_IMG = "https://telegra.ph/file/a462a2c97a7bf40ed9cf3.jpg"
...
def prime_about_callback(update, context):
    ...
    if query.data == "prime_":
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Todorki now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="https://t.me/TodorokiiSupport"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/TodorokiUpdateX"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="prime_"),
        ...
        query.message.edit_text(
            ...
            f"\nHere Developers Making The TodorokiRobot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="reyZ", url="t.me/ryinaja"),
                    InlineKeyboardButton(text="emilia", url="t.me/liatajaaaaaa"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="prime_"),
